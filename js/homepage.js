...
const PRODUCTS_DATA = [
  ...
  // CHECK SHIRTS
  { id: 'p6888', name: "Men's Premium Firoz Printed Cotton Party Wear Shirt", price: 1400, badge: 'Check Shirts', sizes: ['38','40','42','44'], images: ['https://media.treyondworld.com/2023/12/CKS08161-PhotoRoom.png'], url: '/shirts/check/men-premium-firoz-printed-cotton-party-wear-shirt', category: 'check-shirts' },
  { id: 'p9523', name: "Men's Premium Sky Color Printed Cotton Regular Fit Shirt", price: 1400, badge: 'Check Shirts', sizes: ['38','40','42','44'], images: ['https://media.treyondworld.com/2023/12/CKS08164-PhotoRoom.png'], url: '/shirts/check/mens-premium-sky-color-printed-cotton-regular-fit-shirt', category: 'check-shirts' },
  { id: 'p9543', name: "Men's Premium Multi Color Printed Cotton Party Wear Shirt", price: 1400, badge: 'Check Shirts', sizes: ['38','40','42','44'], images: ['https://media.treyondworld.com/2023/12/CKS08288-PhotoRoom.png'], url: '/shirts/check/mens-premium-multi-color-printed-cotton-party-wear-shirt', category: 'check-shirts' },
  { id: 'p9624', name: "Men's Premium Multi Color Printed Cotton Casual Party Wear Shirt", price: 1400, badge: 'Check Shirts', sizes: ['38','40','42','44'], images: ['https://media.treyondworld.com/2023/12/CKS08864-PhotoRoom.png'], url: '/shirts/check/mens-premium-multi-color-printed-cotton-casual-party-wear-shirt', category: 'check-shirts' },
  // STRAP SHIRTS
  { id: 'p9462', name: "Men's Premium Stripe Cotton Formal Shirt", price: 1400, badge: 'Strap Shirts', sizes: ['38','40','42','44'], images: ['https://media.treyondworld.com/2024/06/CKS02478-copy.jpg'], url: '/shirts/strap/mens-stripe-cotton-formal-shirt', category: 'strap-shirts' },
  { id: 'p9482', name: "Men's Light Blue With White Stripe Cotton Formal Shirt", price: 1400, badge: 'Strap Shirts', sizes: ['38','40','42','44'], images: ['https://media.treyondworld.com/2024/06/CKS02491-copy.jpg'], url: '/shirts/strap/mens-light-blue-with-white-stripe-cotton-formal-shirt', category: 'strap-shirts' },
  { id: 'p9503', name: "Men's Premium Multi Color Stripe Cotton Formal Shirt", price: 1400, badge: 'Strap Shirts', sizes: ['38','40','42','44'], images: ['https://media.treyondworld.com/2024/06/CKS02494-copy.jpg'], url: '/shirts/strap/mens-premium-muliti-color-stripe-cotton-formal-shirt', category: 'strap-shirts' },
  // TROUSERS
